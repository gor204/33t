...
currency_date = input("Введите дату на которую вас интересует курс валют в формате dd/mm/yyyy: ")
...
# (1000 шт.) Белорусских рублей стоит(ят) 16,2562 руб. -> 16 / 1000
# (1 шт.) Белорусский рубль стоит(ят) 26,2551 руб.
